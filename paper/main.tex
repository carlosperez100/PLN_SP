...
3,148 \emph{tokens}, de modo que el transformer accede
únicamente al 9.0\% del documento, mientras que TF-IDF lo
...
reproduce ese perfil: la sensibilidad (0.762) supera a la
especificidad (0.770) en el punto de operación elegido, lo
